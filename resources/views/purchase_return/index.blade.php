...
<section class="content" style="background: #fff;border-radius: 10px">
    <section class="content-header " style="border-bottom: .5px solid #000080;padding-bottom: 20px;margin: 0 20px;display: flex; justify-content: space-between">
    <h1>@lang('lang_v1.purchase_return')
    </h1>
    @can('purchase.update')
                <div class="box-tools">
                    <a class="btn btn-block f_add-btn" href="{{action([\App\Http\Controllers\CombinedPurchaseReturnController::class, 'create'])}}">

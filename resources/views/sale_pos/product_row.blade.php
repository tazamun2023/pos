...
{{--			<span class="input-group-btn"><button type="button" class="btn btn-default btn-flat quantity-down" style='width: 35px !important;'><i class="fa fa-minus text-danger"></i></button></span>--}}
		<input style='text-align: center !important; height: 35px !important;' type="text" data-min="1"
			...
			@endif 
		>
{{--		<span class="input-group-btn"><button type="button" class="btn btn-default btn-flat quantity-up" style='width: 35px !important;'><i class="fa fa-plus text-success"></i></button></span>--}}
		</div>

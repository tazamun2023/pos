...
@section('content')
                ...
                <div class="row">
                    ...
                    @if (empty($pos_settings['hide_product_suggestion']) && !isMobile())
                        <div class="col-md-6 no-padding">
                            ...
                            <div class='f_pos_note_div' style="padding-top: 11px !important;padding-bottom: 11px !important;margin-top: 16px;">
                                @if($is_mobile)
                                                    ...
                                                    <div class='pos-form-actions_btn_group'>
                                                        @if ($is_mobile)
                                                            <div class="col-md-12 text-right">
                                                                <b style="font-size: 26px;">@lang('sale.total_payable'):</b>
 ...
 {{--                            @if (!$is_mobile)--}}
								...
								gap: 20px;border-radius: 8px;">
                                    <span class="text" style="font-size: 15px">@lang('sale.total_payable_before_tax')</span>
                                    <span id="new_total_without_tax" class="number" style="font-size: 15px">0</span>
                                    <input type="hidden" name="new_new_total_without_tax" id="new_new_total_without_tax" value="0">
                                </div>
                                <div class="bg-navy pos-total text-white"
                                     style="display: flex;
								align-items: center;
								gap: 20px;border-radius: 8px;">
                                    <span class="text" style="font-size: 15px">@lang('business.tax')</span>
                                    <span id="new_total_tax" class="number" style="font-size: 15px">0</span>
                                    <input type="hidden" name="new_new_total_tax" id="new_new_total_tax" value="0">
                                </div>
                                <div class="bg-navy pos-total text-white"
                                    style="display: flex;
								align-items: center;
								gap: 20px;border-radius: 8px;">
                                    <span  style="font-size: 26px;" class="text">@lang('sale.total_payable')</span>

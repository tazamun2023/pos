<div class="row">
	...
	@if(!empty($accounts))
		<div class="{{$col_class}}">
			<div class="form-group addProduct_form  @if($readonly) hide @endif">
	...
	<div class="col-md-12">
		<div class="form-group addProduct_form ">
			...
			{!! Form::textarea("payment[$row_index][note]", $payment_line['note'], ['class' => 'pos_textarea', 'rows' => 3, 'id' => "note_$row_index"]); !!}
		</div>
	</div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="box f_box box-solid"> <!--business info box start-->
            <div class="box-header" style="margin-bottom: 15px;border: none">
            ...
            <div class="box-body">
                ...
                <button type="submit" class="btn f_btn-primary pull-right">@lang('messages.update')</button>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-8">
        <div class="box f_box box-solid"> <!--business info box start-->
            ...
            <div class="box-body">
                <div class="form-group addProduct_form col-md-2">
                ...
                <div class="form-group addProduct_form col-md-5">
                ...
                <div class="form-group addProduct_form col-md-6">
...
<div class="row">
    <div class="col-md-12 text-center">
        <button type="submit" class="btn f_btn-primary btn-big">@lang('messages.update')</button>
    </div>
</div>
{!! Form::close() !!}

...
<div class="table-responsive">
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
        <tr class="f_tr-th">
          <th class="f_lable_td">@lang('product.default_purchase_price')</th>
          <th class="f_lable_td">@lang('product.profit_percent') @show_tooltip(__('tooltip.profit_percent'))</th>
          <th class="f_lable_td">@lang('product.default_selling_price')</th>
          @if(empty($quick_add))
            <th class="f_lable_td">@lang('lang_v1.product_image')</th>
          @endif
        </tr>
        <tr>
          <td>
            <div class="col-sm-6 addProduct_form">
          ...
          <td class="addProduct_form">
            <label><span class="dsp_label">@lang('product.profit_percent')</span></label>

            {!! Form::text('profit_percent', @num_format($profit_percent), ['class' => 'form-control input-sm input_number addProduct_form', 'id' => 'profit_percent', 'required']); !!}
          </td>

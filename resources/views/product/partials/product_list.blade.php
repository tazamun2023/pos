        ...
        <tr>
            ...
            <div style="display: flex; width: 100%;">
                @can('product.delete')
                    ...
                    {!! Form::submit(__('lang_v1.delete_selected'), array('class' => 'btn btn-xs f_delete_unit_button', 'id' => 'delete-selected')) !!}
                    {!! Form::close() !!}
                @endcan
                    ...
                    @can('product.update')
                        ...
                        @if(config('constants.enable_product_bulk_edit'))
                            ...
                            <button type="submit" class="btn btn-xs btn-primary" id="edit-selected" style=""> <i class="fa fa-edit"></i>{{__('lang_v1.bulk_edit')}}</button>
                            {!! Form::close() !!}
                        @endif
                        &nbsp;
                        <button type="button" class="btn btn-xs f_edit_unit_button update_product_location" data-type="add">@lang('lang_v1.add_to_location')</button>
                        &nbsp;
                        <button type="button" class="btn btn-xs f_view_btn update_product_location" data-type="remove">@lang('lang_v1.remove_from_location')</button>
                    @endcan
                ...
                {!! Form::submit(__('lang_v1.deactivate_selected'), array('class' => 'btn btn-xs f_deactive-btn', 'id' => 'deactivate-selected')) !!}

<div class="modal-dialog modal-lg" role="document">
  ...
  @endphp
    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button" class="btn f_btn-primary center-block more_btn" data-target="#more_div">@lang('lang_v1.more_info') <i class="fa fa-chevron-down"></i></button>
            </div>
          ...
          <div class="col-md-8 col-md-offset-2 addProduct_form  shipping_addr_div mb-10" >

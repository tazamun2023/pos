...
{{--            <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_card_sell - ($register_details->total_card_sell_return + $register_details->total_card_expense_return) }}</span></b>--}}
            <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->net_card_bal - ($register_details->total_expense_card+$register_details->total_sell_return_card_partial-$register_details->total_expense_card_paid) }}</span></b>
        </td>
      </tr>

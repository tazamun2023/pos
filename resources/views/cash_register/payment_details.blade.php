...
{{--          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand+$register_details->net_cash_bal_in_hand+$register_details->total_debit_cash_sell_partial-($register_details->total_sell_return_cash_partial+$register_details->total_expense_paid) }}</span></b>--}}
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand+$register_details->net_cash_bal_in_hand+$register_details->total_debit_cash_sell_partial-($register_details->total_sell_return_cash_partial+$register_details->total_cash_expense) }}</span></b>
...
{{--            <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_card_sell - ($register_details->total_card_sell_return + $register_details->total_card_expense_return) }}</span></b>--}}
            <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->net_card_bal - $register_details->total_sell_return_card_partial-$register_details->total_card_expense }}</span></b>
        </td>
      </tr>

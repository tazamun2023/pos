			...
			<div class="col-md-4 col-sm-6">
		        <div class="form-group addProduct_form">
		        	...
		        	<div class="input-group w-full">
		               {!! Form::number('recur_interval', !empty($expense->recur_interval) ? $expense->recur_interval : null, ['class' => 'form-control', 'style' => 'width: 50%;border-bottom-right-radius: 0 !important;
					   border-top-right-radius: 0 !important;']); !!}
		               
		                {!! Form::select('recur_interval_type', ['days' => __('lang_v1.days'), 'months' => __('lang_v1.months'), 'years' => __('lang_v1.years')], !empty($expense->recur_interval_type) ? $expense->recur_interval_type : 'days', ['class' => 'form-control', 'style' => 'width: 50%;    border-top-left-radius: 0 !important;
						border-bottom-left-radius: 0 !important;
					border-left:none !important', 'id' => 'recur_interval_type']); !!}

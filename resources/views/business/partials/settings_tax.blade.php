        ...
        <div class="col-sm-4">
            <div class="form-group addProduct_form">
                ...
                <div class="input-group w-full">
                    ...
                    {!! Form::text('tax_label_1', $business->tax_label_1, [
                        'class' => 'form-control',
        ...
        <div class="col-sm-4">
            <div class="form-group addProduct_form">
                ...
                <div class="input-group w-full">
                    ...
                    {!! Form::text('tax_label_2', $business->tax_label_2, [
                        'class' => 'form-control',
                        'placeholder' => __('business.tax_1_placeholder'),
                    ]) !!}
                </div>
        ...
        <div class="col-sm-8">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('enable_inline_tax', 1, $business->enable_inline_tax, ['class' => 'input-icheck']) !!} {{ __('lang_v1.enable_inline_tax') }}
                    </label>
                </div>
            </div>
        </div>

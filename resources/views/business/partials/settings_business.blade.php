    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group addProduct_form">
                ...
                {!! Form::select('currency_precision', [0 => 0, 1 => 1, 2 => 2, 3 => 3, 4 => 4], $business->currency_precision, [
                    'class' => 'form-control select2',
                    'required',
                ]) !!}
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group addProduct_form">
                ...
                {!! Form::select('quantity_precision', [0 => 0, 1 => 1, 2 => 2, 3 => 3, 4 => 4], $business->quantity_precision, [
                    'class' => 'form-control select2',
                    'required',
                ]) !!}
            </div>
    ...
    <div class="row hide">
        <div class="col-sm-8">
            <div class="form-group ">
                <label>
                    {!! Form::checkbox(
                        'common_settings[is_enabled_export]',
                        true,

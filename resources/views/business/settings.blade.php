...
@section('content')
    ...
    <section class="content" style="padding: 15px 0">
                ...
                <div class="col-xs-12 pos-tab-container f_pos-tab-container">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu f_pos-tab-menu">
                        <div class="list-group" style="padding: 15px;">
                            <a href="#"
                                class="list-group-item f_list-group-item text-center active">@lang('business.business')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('business.tax')
                                {{-- @show_tooltip(__('tooltip.business_tax')) --}}
                            </a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('business.product')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('contact.contact')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('business.sale')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('sale.pos_sale')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('purchase.purchases')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('lang_v1.payment')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('business.dashboard')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('business.system')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('lang_v1.prefixes')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('lang_v1.email_settings')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('lang_v1.sms_settings')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('lang_v1.reward_point_settings')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('lang_v1.modules')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('lang_v1.custom_labels')</a>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <button class="btn f_btn-primary pull-right" type="submit">@lang('business.update_settings')</button>
            </div>
        </div>
        {!! Form::close() !!}
    </section>

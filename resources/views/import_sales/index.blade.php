...
@section('content')
    ...
    <section class="content-header f_content-header f_product_content-header f_import_content-header"
        ...
        <div class="row">
            ...
            <a class="btn f-download-btn pull-right margin-left-10" href="{{ asset('files/import_sales_template.xlsx') }}">
        ...
        <div class="row f_import_instruction">
            <div class="col-md-12">
                @component('components.widget', ['title' => __('lang_v1.instructions')])
                    <p class="instructions">@lang('lang_v1.instruction_line1') <br>
                        @lang('lang_v1.instruction_line2')
                    </p>

                    <br><br>
                    <table class="table table-condensed import_seals_table">
                        <tr>
                            <td>1.</td>
                ...
                @component('components.widget', ['class' => 'box-primary'])
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <button type="submit" class="btn f_add-btn">@lang('lang_v1.upload_and_review')</button>
                            </div>
                        </div>
                    </div>

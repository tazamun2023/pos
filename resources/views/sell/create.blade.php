...
@section('content')
    <section class="content no-print f_content">
        ...
        <div class="row mb-12">
            <div class="col-md-12">
                <div class="row">
                    ...
                    {{--                                {!! Form::textarea('sale_note_pos', null, ['class' => 'form-control f_pos_note_textarea','placeholder' => __('sale.note'), 'rows' => 8]); !!}--}}
                    {{--                            </div>--}}
                    {{--                        </div>--}}
                    {{--                    @endif--}}
                    <div class="@if (empty($pos_settings['hide_product_suggestion'])) col-md-12 @else col-md-10 col-md-offset-1 @endif no-padding f_no_padding"
                         >
			...
			@lang("lang_v1.send")</button></div>' data-html="true" data-placement="bottom">
                        ...
                        <div class="box box-solid f_pos_products  mb-12">
                            ...
                            <div class='f_action_payment'>
                                ...
                                <div>
                                    @if ($is_mobile)
                                    <div class="col-md-12 text-right f_sale_total_payable">

...
<section class="content" style="background: #fff;border-radius: 10px">
    <section class="content-header " style="border-bottom: 0.5px solid #2E2D4D;padding-bottom: 20px;margin: 0 20px; ">
        <h1>@lang( 'account.trial_balance')
        </h1>
    </section>
    <div class="row no-print">
        <div class="col-sm-12">
            ...
            <div class="col-sm-3 col-xs-6 addProduct_form">
    ...
    <div class="box box-solid">
        ...
        <div class="box-footer">
            <button type="button" class="btn f_btn-primary no-print pull-right"onclick="window.print()">

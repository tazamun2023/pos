<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group addProduct_form percentage-field @if($customer_group->price_calculation_type != 'percentage') hide @endif">
      ...
      <div class="form-group addProduct_form selling_price_group-field @if($customer_group->price_calculation_type != 'selling_price_group') hide @endif">
    ...
    <div class="modal-footer">
      <button type="submit" class="btn f_btn-primary">@lang( 'messages.update' )</button>

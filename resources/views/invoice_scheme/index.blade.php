...
@section('content')
    ...
    <section class="content" style="padding: 15px 0">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- Custom Tabs -->
                <div class="nav-tabs-custom" style="border-radius: 10px;overflow: hidden;">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4>@lang('invoice.all_your_invoice_schemes') </h4>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive w-full">
                                        <table class="table table-bordered table-striped w-full" id="invoice_table">
                                            <thead>
                                                <tr class="f_tr-th">
                        ...
                        <div class="tab-pane" id="tab_2">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4>@lang('invoice.all_your_invoice_layouts') <a class="btn f_add-btn pull-right"

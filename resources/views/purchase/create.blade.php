...
<section class="content no-print" style="padding: 15px 0;">
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row f_purchase_inp">
			<div class="col-sm-2 text-center">
				<button type="button" class="btn f_add-btn btn-flat" data-toggle="modal" data-target="#import_purchase_products_modal">@lang('product.import_products')</button>
			</div>
			<div class="col-sm-8">
				<div class="form-group addProduct_form">
					<div class="input-group w-full">
	...
	<div class="row">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<button type="button" class="btn f_btn-primary btn-sm" id="toggle_additional_expense"> <i class="fas fa-plus"></i> @lang('lang_v1.add_additional_expenses') <i class="fas fa-chevron-down"></i></button>
			</div>
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_payment')])
		<div class="box-body payment_row">
			...
			<div class="row">
				<div class="col-sm-12">
					<button type="button" id="submit_purchase_form" class="btn f_add-btn pull-right btn-flat">@lang('messages.save')</button>
				</div>
			</div>
		</div>
	@endcomponent

        ...
        <div class="row eq-height-row">
                        ...
                        <ul style="" class="right-col-ul">
                            ...
                            @if(!($request->segment(1) == 'business' && $request->segment(2) == 'register'))
                                    @if(config('constants.allow_registration'))
                                        <li>
                                            <a style='color: #000000' href='{{ route('business.getRegister') }} @if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif'><b>{{ __('business.not_yet_registered') }}</b>{{ __('business.register_now') }}</a>
                                        </li>
                                    @endif
                            @endif
            ...
            <div class="container auth_footer_wrapper">
                ...
                <div class="auth_footer_left">
                    <ul>
                        <li>
                            <a href="https://www.instagram.com/tazamunksa">
                        ...
                        <li>
                            <a href="https://www.facebook.com/tazamunksa">
                        ...
                        <li>
                            <a href="https://www.twitter.com/tazamunksa">

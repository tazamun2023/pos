...
<section class="content-header no-print f_content-header f_product_content-header">
    ...
    <div class="row" style="margin-top: 20px">
        <div class="col-md-12">
            <div class="nav-tabs-custom" style="border-radius: 10px !important;overflow: hidden;padding: 20px;">
                <ul class="nav nav-tabs f_psr_detailed_nav" style="margin-bottom: 20px">
                    <li class="active">
                        <a href="#psr_detailed_tab" data-toggle="tab" aria-expanded="true"> @lang('lang_v1.detailed')</a>
                    </li>
                    <li>
                        <a href="#psr_detailed_with_purchase_tab" data-toggle="tab" aria-expanded="true"> @lang('lang_v1.detailed_with_purchase')</a>
                    </li>
                    <li>
                        <a href="#psr_grouped_tab" data-toggle="tab" aria-expanded="true"> @lang('lang_v1.grouped')</a>
                    </li>
                    <li>
                        <a href="#psr_by_cat_tab" data-toggle="tab" aria-expanded="true"> @lang('lang_v1.by_category')</a>
                    </li>
                    <li>
                        <a href="#psr_by_brand_tab" data-toggle="tab" aria-expanded="true"> @lang('lang_v1.by_brand')</a>
                    </li>
                </ul>

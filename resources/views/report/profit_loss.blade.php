...
@section('content')
    ...
    <section class="content" style="background: #fff;border-radius: 10px">
        ...
        <div class="row no-print" style="padding: 15px 20px;}">
            ...
            <div class="col-md-2 col-md-offset-6 col-xs-6">
                <div class="form-group pull-right">
                    <div class="input-group">
                        <button type="button" class="btn f_btn-primary" id="profit_loss_date_filter">
                            <span>
        ...
        <div class="row no-print">
            <div class="col-sm-12">
                <button type="button" class="btn f_add-btn pull-right" aria-label="Print" onclick="window.print();"><i
        ...
        <div class="row no-print">
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs f_profit_nav">
                        <li class="active">

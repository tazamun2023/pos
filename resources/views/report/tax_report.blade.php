...
<section class="content-header f_content-header f_product_content-header">
    ...
    <div class="row no-print" style="margin-bottom: 20px">
        <div class="col-sm-12">
            <button type="button" class="btn f_add-btn pull-right" 
        ...
        <div class="col-md-12">
           <!-- Custom Tabs -->
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs f_tax_report">
                    <li class="active">
                ...
                <div class="tab-content f_resp_table_container">
                    <div class="tab-pane active f_res_table" id="input_tax_tab">
                    ...
                    <div class="tab-pane f_res_table" id="output_tax_tab">
                    ...
                    <div class="tab-pane f_res_table" id="expense_tax_tab">

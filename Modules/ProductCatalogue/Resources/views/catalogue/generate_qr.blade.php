...
<section class="content" style="padding: 15px 0;">
    ...
    <div class="row">
    	...
    	@component('components.widget', ['class' => 'box-solid'])
            ...
            <button type="button" class="btn f_btn-primary" id="generate_qr">@lang( 'productcatalogue::lang.generate_qr' )</button>
        @endcomponent
        @component('components.widget', ['class' => 'box-solid'])
            <div class="row">
                <div class="col-md-12">
                    <strong style="margin-bottom: 10px;display: block;">@lang('lang_v1.instruction'):</strong>

  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
    	<div class="row">
    		...
    		<div class="form-group addProduct_form col-md-12">
    		...
    		<div class="form-group addProduct_form col-md-12">
	      	...
	      	<div class="form-group addProduct_form col-md-6">
	        	...
	        	<div class="input-group data w-full">
    ...
    <div class="modal-footer">
      <button type="submit" class="btn f_btn-primary ladda-button add-leave-btn" data-style="expand-right">

...
<section class="content" style="padding: 15px 0">
    ...
    <section class="content-header f_content-header f_product_content-header">
        <h1>@lang('essentials::lang.leave')</h1>
        <div class="box-tools">
            <button type="button" class="btn btn-block f_add-btn btn-modal" data-href="{{action([\Modules\Essentials\Http\Controllers\EssentialsLeaveController::class, 'create'])}}" data-container="#add_leave_modal">

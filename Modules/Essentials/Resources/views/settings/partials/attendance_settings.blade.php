<div class="pos-tab-content" style="border-radius: 10px;padding: 26px;">
    <div class="row f_hrm_atte_sett">
        <div class="col-xs-6">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('is_location_required', 1, !empty($settings['is_location_required']) ? 1 : 0, [
                        'class' => 'input-icheck',
        ...
        <div class="col-xs-6">
            <div class="form-group addProduct_form">
                ...
                {!! Form::number(
                    ...
                    ['class' => 'form-control', 'placeholder' => __('essentials::lang.grace_before_checkin'), 'step' => 1],
                ) !!}
        ...
        <div class="col-xs-6">
            <div class="form-group addProduct_form">
                ...
                {!! Form::number(
                    ...
                    ['class' => 'form-control', 'placeholder' => __('essentials::lang.grace_after_checkin'), 'step' => 1],
                ) !!}
        ...
        <div class="col-xs-6">
            <div class="form-group addProduct_form">
                ...
                {!! Form::number(
                    ...
                    ['class' => 'form-control', 'placeholder' => __('essentials::lang.grace_before_checkout'), 'step' => 1],
                ) !!}
        ...
        <div class="col-xs-6">
            <div class="form-group addProduct_form">
                ...
                {!! Form::number(
                    ...
                    ['class' => 'form-control', 'placeholder' => __('essentials::lang.grace_after_checkout'), 'step' => 1],
                ) !!}
                <p class="help-block">@lang('essentials::lang.grace_before_checkin_help')</p>
            </div>
        </div>

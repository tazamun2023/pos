...
@section('content')
    ...
    <section class="content" style="padding: 15px 0;">
		...
		<section class="content-header f_content-header f_product_content-header" style="margin-bottom: 25px">
			...
			<button type="button" class="btn btn-sm f_add-btn add_doc">
        ...
        <div class="box f_box box-solid">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::open([
                            'url' => action([\Modules\Essentials\Http\Controllers\DocumentController::class, 'store']),
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-sm-6 f_leave_ref_no_prefix">
                                ...
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    <button type="submit" class="btn f_btn-primary btn-sm">
    ...
    <div class="modal fade document" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"

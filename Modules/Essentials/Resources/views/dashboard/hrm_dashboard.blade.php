        ...
        <section class="content-header f_content-header f_product_content-header">
            ...
            <div class=" text-center">
                <a href="{{ action([\Modules\Essentials\Http\Controllers\PayrollController::class, 'getMyPayrolls']) }}"
                    class="btn btn-lg f_my_payrolls_btn">
                    {{-- <i class="fas fa-coins"></i> --}}
                    @lang('essentials::lang.my_payrolls')
                </a>
            </div>
        </section>
        <div class="row row-custom" style="margin-top: 35px ">
            <div class="col-md-6 col-sm-6 col-xs-12 col-custom">
                <div class="box box-solid hrm_box" >
                    <div class="box-header with-border" >
                        <i class="fas fa-sign-out-alt"></i>
                        <h3 class="box-title" >
                            @lang('essentials::lang.my_leaves')</h3>
                    </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-custom">
                <div class="box box-solid hrm_box" >
                    <div class="box-header with-border" >
                        ...
                        <h3 class="box-title" >
                            @lang('essentials::lang.my_sales_targets')</h3>
                    </div>
                    <div class="box-body p-10">
                        <table class="table no-margin">
                            <thead>
                        ...
                        <div class="box-body p-10">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" rowspan="9" class="text-center">@lang('lang_v1.no_data')</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>

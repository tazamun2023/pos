...
<section class="content" style="padding: 15px 0">
    ...
    <section class="content-header f_content-header f_product_content-header">
        <h1>@lang('essentials::lang.payroll')</h1>
        @can('essentials.create_payroll')
        <div class="col-md-12">
            <button type="button" class="btn f_add-btn pull-right" data-toggle="modal" data-target="#payroll_modal">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom " style="padding: 20px;border-radius: 8px;">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="payroll_tab" style="margin-top: 10px">
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    @can('essentials.view_all_payroll')
                        <div class="tab-pane" id="payroll_group_tab" style="margin-top: 10px">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                    ...
                    @endcan
                    @if(auth()->user()->can('essentials.view_allowance_and_deduction') || auth()->user()->can('essentials.add_allowance_and_deduction'))
                        <div class="tab-pane" id="pay_component_tab" style="margin-top: 10px">
                            <div class="row">
                                @can('essentials.add_allowance_and_deduction')
                                    <div class="col-md-12">
                                        <button type="button" class="btn f_add-btn btn-modal pull-right" data-href="{{action([\Modules\Essentials\Http\Controllers\EssentialsAllowanceAndDeductionController::class, 'create'])}}" data-container="#add_allowance_deduction_modal">

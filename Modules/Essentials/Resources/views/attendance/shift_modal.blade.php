  	...
  	<div class="modal-content">
	    ...
	    <div class="modal-body">
	    	<div class="form-group addProduct_form">
	      	...
	      	<div class="form-group addProduct_form time_div">
    		...
    		<div class="form-group addProduct_form enable_auto_clock_out_time" style="display: none;">
	    ...
	    <div class="modal-footer">
	      	<button type="submit" class="btn f_btn-primary">@lang( 'messages.submit' )</button>

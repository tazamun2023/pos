...
<section class="content" style="padding: 15px 0">
    ...
    <section class="content-header f_content-header f_product_content-header">
        ...
        <button type="button" class="btn f_add-btn pull-right"  data-toggle="modal" data-target="#shift_modal"> <i class="fa fa-plus"></i> @lang( 'messages.add' )</button>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom" style="padding: 20px;border-radius: 10px;">
                <ul class="nav nav-tabs hrm_attendance_nav">
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="shifts_tab">
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-md-12 " style="text-align: right">
                                    <button 
                                        type="button" 
                                        class="btn btn-app bg-blue clock_in_btn f_attendance_clock_in_btn
                                            @if(!empty($clock_in))
                                                hide
                                            @endif
                                        "
                    ...
                    @endcan
                    <div class="tab-pane @if(!auth()->user()->can('essentials.crud_all_attendance')) active @endif" id="attendance_tab" style="margin-top: 10px">
                        <div class="row">
                            @can('essentials.crud_all_attendance')
                                <div class="col-md-3">
                            ...
                            <div class="col-md-6 spacer">
                                <button type="button" class="btn f_add-btn btn-modal pull-right" data-href="{{action([\Modules\Essentials\Http\Controllers\AttendanceController::class, 'create'])}}" data-container="#attendance_modal">
                    ...
                    <div class="tab-pane" id="attendance_by_shift_tab" style="margin-top: 10px">

...
<section class="content" style="padding: 15px 0;">
    ...
    <h1>@lang('superadmin::lang.super_admin_settings')<small>@lang('superadmin::lang.edit_super_admin_settings') h</small></h1>
    <!-- <ol class="breadcrumb">
            ...
            <div class="col-xs-12 pos-tab-container f_pos-tab-container">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu f_pos-tab-menu">
                    <div class="list-group" style="padding: 15px;">
                        <a href="#" class="list-group-item f_list-group-item text-center active">@lang('superadmin::lang.super_admin_settings')</a>
                        <a href="#" class="list-group-item f_list-group-item text-center">@lang('superadmin::lang.application_settings')</a>
                        <a href="#" class="list-group-item f_list-group-item text-center">@lang('superadmin::lang.email_smtp_settings')</a>
                        <a href="#" class="list-group-item f_list-group-item text-center">@lang('superadmin::lang.payment_gateways')</a>
                        <a href="#" class="list-group-item f_list-group-item text-center">@lang('superadmin::lang.backup')</a>
                        <a href="#" class="list-group-item f_list-group-item text-center">@lang('superadmin::lang.cron')</a>
                        <a href="#" class="list-group-item f_list-group-item text-center">@lang('superadmin::lang.pusher_settings')</a>
                        <a href="#" class="list-group-item f_list-group-item text-center">@lang('superadmin::lang.additional_js_css')</a>
                    </div>
                </div>

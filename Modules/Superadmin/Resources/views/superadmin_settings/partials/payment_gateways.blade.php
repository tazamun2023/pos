<div class="pos-tab-content" style="border-radius: 10px;padding: 20px !important;">
    ...
    <div class="row">
    	<h4 style="padding: 0 15px">Stripe:</h4>
    	<div class="col-xs-4">
            <div class="form-group addProduct_form">
        ...
        <h4 style="padding: 0 15px">Paypal:</h4>
        <div class="col-xs-6">
            <div class="form-group addProduct_form">
        ...
        <h4 style="padding: 0 15px">Razorpay: <small>(For INR India)</small></h4>
        <div class="col-xs-4">
            <div class="form-group addProduct_form">
        ...
        <h4 style="padding: 0 15px">Pesapal: <small>(For KES currency)</small></h4>
        <div class="col-xs-4">
            <div class="form-group addProduct_form">
        ...
        <h4 style="padding: 0 15px">Paystack: <small>(For NGN Nigeria, GHS Ghana)</small></h4>
        <div class="col-xs-6">
            <div class="form-group addProduct_form">
        ...
        <h4 style="padding: 0 15px"> Flutterwave:</h4>
        <div class="col-xs-4">
            <div class="form-group addProduct_form">

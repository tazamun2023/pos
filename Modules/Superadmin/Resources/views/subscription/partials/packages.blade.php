@foreach ($packages as $package)
    ...
    <div class="col-md-4">
        ...
        <div class="box f_box  hvr-grow-shadow" style="box-shadow: -2px 2px 14px 1px rgba(0, 0, 0, 0.1) !important">
            <div class="box-header with-border text-center" style="margin-bottom: 15px">
            ...
            <div class="box-footer bg-gray disabled text-center">
                @if ($package->enable_custom_link == 1)
                    <a href="{{ $package->custom_link }}"
                        class="btn btn-block btn-success">{{ $package->custom_link_text }}</a>
                @else

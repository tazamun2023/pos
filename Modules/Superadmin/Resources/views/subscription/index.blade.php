    ...
    <section class="content">
        ...
        <div class="box f_box">
            ...
            <div class="box-body">
                @if (!empty($active))
                    <div class="col-md-4">
                        <div class="box f_box box-success"
                            ...
                            <div class="box-body "
                                style="display: flex;flex-direction: column;gap:10px ;font-weight: 500;font-size: 16px;line-height: 20px;color: #2E2D4D;">
                                ...
                                <span> @lang('superadmin::lang.remaining', ['days' => \Carbon::today()->diffInDays($active->end_date)])</span>

...
@section('content')
    ...
    <section class="content" style="padding: 15px 0">
        ...
        {!! Form::open([
            'action' => '\Modules\Cms\Http\Controllers\SettingsController@store',
            'id' => 'site_details_form',
            'method' => 'post',
            'files' => true,
                        ...
                        <div class="col-xs-12 pos-tab-container f_pos-tab-container">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu f_pos-tab-menu">
                                <div class="list-group" style="padding: 15px">
                                    <a href="#" class="list-group-item f_list-group-item text-center active">
                                        @lang('cms::lang.application')
                                    </a>
                                    <a href="#" class="list-group-item f_list-group-item text-center">
        ...
        <div class="row">
            <div class="col-md-12 text-right">
                <button type="submit" class="btn f_btn-primary submit-btn btn-lg">@lang('messages.submit')</button>
            </div>
        </div>
        {!! Form::close() !!}
    </section>

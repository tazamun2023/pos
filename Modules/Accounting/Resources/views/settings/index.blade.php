...
@section('content')
    ...
    <section class="content" style="padding: 15px 5px">
        ...
        <div class="row">
            ...
            border-radius: 10px;">
                    <ul class="nav nav-tabs account_setting_nav">
                        <li class="active">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="account_setting">
                            <div class="row mb-12">
                                <div class="col-md-4">
                                    <button class="btn  accounting_reset_data f_reset_data_btn"
                            ...
                            <div class="row" style="display: flex; align-items: center ">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group w-full " style="margin-bottom: 0 !important">
                                        {{ Form::submit('update', ['class' => 'btn f_btn-primary accounting_settings_update_btn w-full']) }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="sub_type_tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn f_add-btn pull-right" id="add_account_sub_type">
                        ...
                        <div class="tab-pane" id="detail_type_tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn f_add-btn pull-right" id="add_detail_type">
                                        <i class="fas fa-plus"></i> @lang('messages.add')
                                    </button>
                                </div>
                                <div class="col-md-12">

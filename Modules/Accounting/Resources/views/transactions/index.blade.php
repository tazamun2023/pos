                ...
                <div class="col-xs-12 pos-tab-container f_pos-tab-container">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu f_pos-tab-menu">
                        <div class="list-group " style="padding: 15px;">
                            <a href="#"
                                class="list-group-item f_list-group-item text-center active">@lang('sale.sale')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('accounting::lang.sales_payments')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('purchase.purchases')</a>
                            <a href="#" class="list-group-item f_list-group-item text-center">@lang('accounting::lang.purchase_payments')</a>
                        </div>
                    </div>

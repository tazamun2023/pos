...
@section('content')
	...
	<section class="content no-print" style="padding: 15px 0;">
		...
		<div class="box-tools pull-right">
			<a type="button" class="btn btn-sm f_add-btn" data-href="{{action([\Modules\AssetManagement\Http\Controllers\AssetController::class, 'create'])}}" id="add_asset">
		...
		@endcomponent
		<div class="box f_box box-solid" style="margin-top: 15px">

    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6" >
                    <button type="button" style="margin: 20px 0" class="btn f_btn-primary btn-sm pull-right" id="add_more_warranty"><i class="fas fa-plus"></i> @lang('assetmanagement::lang.add_more')</button>
                </div>
                <div class="col-md-12">
               <div class="f_resp_table_container">
                <div class="f_res_table w-full">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn f_btn-primary">
                @lang('messages.save')
            </button>
        </div>
    </div>

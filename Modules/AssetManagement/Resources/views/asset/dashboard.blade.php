...
@section('content')
	...
	<section class="content no-print" style="padding: 15px 0">
		<div class="row">
			<div class="col-md-4">
				<div class="info-box f_box info-box-new-style" style="height: 180px !important;">
	            	{{-- <span class="info-box-icon bg-aqua"><i class="fas fa-boxes"></i></span> --}}

	            	<div class="info-box-content f_info-box-content " >
	            	...
	            	<!-- /.info-box-content f_info-box-content -->
	          	</div>
			</div>

			<div class="col-md-4">
				<div class="box f_box box-solid" style="height: 180px !important;">
					<div class="box-body">
						<table class="table">
							<thead>
								<tr class="f_tr-th">
			...
			<div class="col-md-4">
				<div class="info-box f_box info-box-new-style" style="height: 180px !important;">
					...
					<div class="info-box-content f_info-box-content"  style="margin: 0 !important;">
